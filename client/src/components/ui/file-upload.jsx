          ...
          <div className='relative mx-auto mt-10 w-full max-w-xl'>
            ...
            {!files.length && (
              <motion.div
                ...
                className='relative z-40 mx-auto mt-4 flex h-32 w-full max-w-[8rem] items-center justify-center rounded-md border border-slate bg-bg/70 backdrop-blur-md group-hover/file:border-signal group-hover/file:shadow-2xl'
              >
                {isDragActive ? (
                  <motion.p
                    initial={{ opacity: 0 }}
